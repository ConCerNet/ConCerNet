...
export declare class EcommerceApi {
    ...
    ecommerceAttributionMetricsConversionSourceConversionSourceIdGet(conversionSource: any, conversionSourceId: any, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    ecommerceAttributionMetricsGet(periodFrom?: any, periodTo?: any, emailCampaignId?: any, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    ecommerceAttributionProductsConversionSourceConversionSourceIdGet(conversionSource: any, conversionSourceId: any, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
