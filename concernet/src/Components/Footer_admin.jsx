    ...
    return(
        <div className="footer">
            <footer className="footerContainer">
                ...
                <ul className="menu">
                    <li>
                        <Link to="/usuarios_admin" className="enlace">Usuarios</Link>
                    </li>
                    <li>
                        <Link to="/viviendas_admin" className="enlace">Viviendas</Link>
                    </li>
                    <li>
                        <Link to="/reporte_pagos" className="enlace">Pagos</Link>
                    </li>
                    <li>
                        {auth.user ? (
